    ...
    simplyCountdown('#cuenta-index', {
        ...
        onEnd: function() { 
            alert('Comenzaron los Juegos!');
            return; }, //Callback on countdown end, put your own function here
        refresh: 1000, // default refresh every 1s
        sectionClass: 'simply-section-index', //section css class
        amountClass: 'simply-amount-index', // amount css class
        wordClass: 'simply-word-index', // word css class
        zeroPad: false,
        countUp: false
});
